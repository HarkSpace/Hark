      ...
      <div class="agreement-content">
        ...
        <div class="agreement-body">
          <section>
            <h2>引言</h2>
            <p>
              THOIFR（以下简称"我们"）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺，我们将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。
            </p>
          ...
          <section>
            ...
            <p>（1）账号注册：当您注册THOIFR账号时，我们需要收集您的手机号码、邮箱地址等信息，以便为您创建账号。</p>
            <p>（2）身份验证：为了确保账号安全，我们可能需要您提供身份证明文件进行实名认证。</p>
            <p>（3）服务使用：在您使用THOIFR服务过程中，我们会收集您的聊天记录、好友关系、群组信息等。</p>
          ...
          <section>
            ...
            <h3>3.1 共享</h3>
            <p>我们不会与THOIFR以外的公司、组织和个人共享您的个人信息，但以下情况除外：</p>
            <p>（1）事先获得您明确的同意或授权；</p>
            <p>（2）根据适用的法律法规、法律程序的要求、强制性的政府要求或司法裁定；</p>
            <p>（3）在法律要求或允许的范围内，为了保护THOIFR、THOIFR用户或公众的权利、财产或安全免遭损害；</p>
